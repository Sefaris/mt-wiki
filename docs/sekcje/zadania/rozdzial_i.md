---
title: Rozdział I
description: "Pierwszy rozdział solucji do Mrocznych Tajemnic 2.5. Zadania obozów, przemytnicy, łowcy orków, fanatycy i starożytna arena."
slug: /solucja/rozdzial-i/
---

## Pomóc Diego {#pomoc-diego}
Zadanie otrzymujemy od Diego na samym początku przygody, kiedy wypytamy go o pozostałe obozy. Wspomina wtedy o obozie Przemytników i podpowiada nam, jak do nich dotrzeć. Zanim jednak tam wyruszymy, warto porozmawiać z Kyro i wykonać zadanie [Łuk Kyro](#luk-kyro).
...
## Arena w Starym Obozie {#arena-w-starym-obozie}
...
## Pierścień Klina {#pierscien-klina}
...
## Sakiewki dla Rączki {#sakiewki-dla-raczki}
...
## Pomóc przemytnikom {#pomoc-przemytnikom}
...
Aby je ukończyć, musimy wykonać zadania związane z przemytnikami: [Góra stali dla Anghara](#gora-stali-dla-anghara), [Ruda dla Monka](#ruda-monka), [Łuk Kyro](#luk-kyro), [Pierścień Kortha](#pierscien-kortha), [Pomóc Servinowi](#pomoc-servinowi), aż do momentu rozmowy z Wężem o osobie odpowiedzialnej za przemyt rudy.

## Góra stali dla Anghara {#gora-stali-dla-anghara}
...
## Kowal Anghar {#kowal-anghar}
Zadanie otrzymujemy, gdy zgadzamy się przynieść mu stal. Po wykonaniu zadania [Góra stali dla Anghara](#gora-stali-dla-anghara) opowiada nam historię o byciu paladynem.
...
## Łuk Kyro {#luk-kyro}
Kyro prosi nas o odnalezienie jego łuku, który znajduje się w jaskini przy zwłokach jego towarzysza Nikolasa, niedaleko rzeki.
Po odnalezieniu łuku wracamy do Kyro i przekazujemy mu znalezisko, kończąc zadanie.

## Pierścień Kortha {#pierscien-kortha}
...
## Poszukiwanie skarbów {#poszukiwanie-skarbow}
...
4. Misa z krwią demona – znajduje się w zatopionej wieży Xardasa (lewa wnęka). Dostęp do niej otrzymujemy dopiero podczas wykonywania zadania [Zbuntowany sługa](./rozdzial_v.md#zbuntowany-sluga).
...
## Zaopatrzenie dla bandytów {#zaopatrzenie-dla-bandytow}
...
## Rosół dla Radiego {#rosol-dla-radiego}
...
## Szewc Fiska {#szewc-fiska}
Fisk poszukuje nowego szewca. Udajemy się do Draxa, który zgadza się podjąć pracy. Następnie wracamy do Fiska, aby przekazać mu informację. W nagrodę otrzymujemy spodnie Kopacza. Spodnie można również zdobyć podczas zadania [Rosół dla Radiego](#rosol-dla-radiego).

## Łowca orków Traffix {#lowca-orkow-traffix}
...
## Ekwipunek Siekacza {#ekwipunek-siekacza}
Zadanie otrzymujemy po wykonaniu [Łowca orków Traffix](#lowca-orkow-traffix). Siekacz chce odzyskać swoje spodnie i baseball.
...
## Tajemniczy Eremita {#tajemniczy-eremita}
...
## Joint dla Gortha {#joint-dla-gortha}
...
## Dwanaście piw dla Komara {#dwanascie-piw-dla-komara}
...
## Jedzenie dla kowala Sanda {#jedzenie-dla-kowala-sanda}
...
## Kłopotliwy kucharz {#klopotliwy-kucharz}
...
## Lekarstwo Dorma {#lekarstwo-dorma}
...
## Przebranie kopacza {#przebranie-kopacza}
Aby wejść do Starej Kopalni, potrzebujemy spodni Kopacza. Można je zdobyć wykonując quest [Szewc Fiska](#szewc-fiska) lub [Rosół dla Radiego](#rosol-dla-radiego).

## Ziele dla Corina {#ziele-dla-corina}
...
## Skrytka kopaczy {#skrytka-kopaczy}
...
## Zaginiony miecz {#zaginiony-miecz}
...
## Gdzie jest strażnik? {#gdzie-jest-straznik}
Po zwróceniu miecza dla Wislava ma on jeszcze jedną prośbę. Jeden ze strażników udał się na zwiady w okolice obozu Sekty, lecz do tej pory nie wrócił. Znajdujemy go martwego w lesie niedaleko obozu, zagryzionego przez kretoszczury. Czytamy znalezioną przy nim notatkę i wracamy do Wislava po nagrodę.

## Dziwne poszukiwania {#dziwne-poszukiwania}
...
## Ułatwiony awans w Starym Obozie {#ulatwiony-awans-w-starym-obozie}
...
## Ułatwiony awans na Najemnika {#ulatwiony-awans-na-najemnika}
...
## Ułatwiony awans na Strażnika Świątynnego {#ulatwiony-awans-na-straznika-swiatynnego}
...
## Zapasy dla gwardzisty {#zapasy-dla-gwardzisty}
...
## Przyjęcie do obozu Fanatyków {#przyjecie-do-obozu-fanatykow}
...
## Pierścień Pradawnych {#pierscien-pradawnych}
...
## Odnaleźć Pradawnych {#odnalezc-pradawnych}
...
## Starożytna arena {#starozytna-arena}
